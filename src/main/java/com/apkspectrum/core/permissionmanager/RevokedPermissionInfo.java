...
public class RevokedPermissionInfo extends PermissionInfo {
    ...
    public static RevokedPermissionInfo makeRevokedReason(PermissionRecord record, int sdk,
            int targetSdk, boolean treatSignAsRevoked) {
    ...
    public static RevokedPermissionInfo makeRevokedReason(DeclaredPermissionInfo declared,
            int sdk) {
        ...
        if (!declared.isUsed) {
            ...
            Log.v("This SDK(" + sdk + ") version was not have permission. " + reason.name
                    + " over maxsdk " + declared.maxSdkVersion);
