...
public class AxmlToXml {
    ...
    public AxmlToXml(AaptNativeScanner resourceScanner) {
        ...
        _RProp.addPropertyChangeListener(_RProp.PRINT_MULTILINE_ATTR
    ...
    private String makeNodeXml(AaptXmlTreeNode node, String namespace
            , String depthSpace) {
        ...
        */
        for(String name: node.getAttributeList()) {
            ...
            String val = resourceScanner.getResourceName(
            ...
            if(name.endsWith("protectionLevel")) {
            ...
            } else if(name.endsWith("layout_width")
                    || name.endsWith("layout_height")) {
                switch(val) {
                ...
                default: break;
                    ...
                    || name.endsWith("foregroundGravity")) {
                if(val != null && val.startsWith("0x")) {
