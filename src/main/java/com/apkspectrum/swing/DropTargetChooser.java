...
public class DropTargetChooser extends JComponent {
    ...
    protected class DropArea extends JComponent implements FileDrop.Listener {
        ...
        public DropArea(Object dropTarget, String text, String title, Image image,
                Color background) {
    ...
    protected void addDropTarget(Object dropTarget, String text, String title, Image image,
            Color background, boolean visible) {
