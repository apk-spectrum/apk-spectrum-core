...
public class UIActionEvent extends ActionEvent {
    ...
    public UIActionEvent(Object source, int id, String command, Object userData) {
        super(source, id, command);
        setUserObject(userData);
    }

    public UIActionEvent(Object source, int id, String command, int modifiers, Object userData) {
    ...
    public UIActionEvent(Object source, int id, String command, long when, int modifiers) {
