...
public class MessageBoxPane extends JOptionPane {
    ...
    public MessageBoxPane(Object message, int messageType, int optionType, Icon icon) {
    ...
    public static String showInputDialog(Component parentComponent, Object message)
        ...
        return showInputDialog(parentComponent, message,
                UIManager.getString("OptionPane.inputDialogTitle"), QUESTION_MESSAGE);
    }
    ...
    public static Object showInputDialog(Component parentComponent, Object message, String title,
            ...
            throws HeadlessException {
        MessageBoxPane pane =
                new MessageBoxPane(message, messageType, OK_CANCEL_OPTION, icon, null, null);
    ...
    public static void showMessageDialog(Component parentComponent, Object message)
        ...
        showMessageDialog(parentComponent, message,
                UIManager.getString("OptionPane.messageDialogTitle"), INFORMATION_MESSAGE);
    }
    ...
    public static int showOptionDialog(Component parentComponent, Object message, String title,
            ...
            throws HeadlessException {
        MessageBoxPane pane =
                new MessageBoxPane(message, messageType, optionType, icon, options, initialValue);
        ...
        if (message instanceof Component) {
            ((Component) message).addComponentListener(new ComponentAdapter() {
                ...
                public void componentResized(ComponentEvent arg0) {
                    ...
                    if (prePreferedHeight < preferSize.height && size.height < preferSize.height) {
    ...
    public static void showTextAreaDialog(Component parentComponent, String text, String title,
            int messageType, Icon icon, Dimension size) {
        showTextAreaDialog(parentComponent, null, text, title, messageType, icon, size);
    }

    public static void showTextAreaDialog(Component parentComponent, String subject, String text,
            String title, int messageType, Icon icon, Dimension size) {
        ...
        showOptionDialog(parentComponent, panel, title, DEFAULT_OPTION, messageType, icon, null,
                null);
    }

    public static void showInfomation(Component parentComponent, Object message) {
        showMessageDialog(parentComponent, message, _RStr.LABEL_INFO.get(), INFORMATION_MESSAGE,
                null);
    }

    public static void showWarring(Component parentComponent, Object message) {
        showMessageDialog(parentComponent, message, _RStr.LABEL_WARNING.get(), WARNING_MESSAGE,
                null);
    }

    public static void showError(Component parentComponent, Object message) {
        showMessageDialog(parentComponent, message, _RStr.LABEL_ERROR.get(), ERROR_MESSAGE, null);
    }

    public static int showQuestion(Component parentComponent, Object message, int optionType) {
        return showConfirmDialog(parentComponent, message, _RStr.LABEL_QUESTION.get(), optionType,
