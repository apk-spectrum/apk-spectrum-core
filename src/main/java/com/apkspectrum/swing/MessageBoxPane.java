...
public class MessageBoxPane extends JOptionPane
{
	...
	public static void showInfomation(Component parentComponent, Object message) {
		showMessageDialog(parentComponent, message, _RStr.LABEL_INFO.get(), INFORMATION_MESSAGE, null);
	}

	public static void showWarring(Component parentComponent, Object message) {
		showMessageDialog(parentComponent, message, _RStr.LABEL_WARNING.get(), WARNING_MESSAGE, null);
	}
	...
	public static int showQuestion(Component parentComponent, Object message, int optionType) {
		return showConfirmDialog(parentComponent, message, _RStr.LABEL_QUESTION.get(), optionType, QUESTION_MESSAGE, null);
	}
