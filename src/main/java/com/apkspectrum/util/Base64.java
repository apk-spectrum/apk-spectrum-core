...
public class Base64 {
    ...
    private static class Base64Decoder implements Decoder {
        ...
        private Base64Decoder(String createInstanceMethod) throws ClassNotFoundException {
            ...
            try {
                instance = Class.forName("java.util.Base64").getMethod(createInstanceMethod)
                        .invoke(null);
        ...
        public int decode(byte[] src, byte[] dst) {
            try {
                return (int) clazz.getMethod("decode", byte[].class, byte[].class).invoke(instance,
                        src, dst);
            } catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException
                    | NoSuchMethodException | SecurityException e) {
                e.printStackTrace();
        ...
        public ByteBuffer decode(ByteBuffer buffer) {
            try {
                return (ByteBuffer) clazz.getMethod("decode", ByteBuffer.class).invoke(instance,
                        buffer);
            } catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException
                    | NoSuchMethodException | SecurityException e) {
                e.printStackTrace();
        ...
        public InputStream wrap(InputStream is) {
            try {
                return (InputStream) clazz.getMethod("wrap", InputStream.class).invoke(instance,
                        is);
            } catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException
                    | NoSuchMethodException | SecurityException e) {
                e.printStackTrace();
    ...
    public static class Base64Encoder implements Encoder {
        ...
        public int encode(byte[] src, byte[] dst) {
            try {
                return (int) clazz.getMethod("encode", byte[].class, byte[].class).invoke(instance,
                        src, dst);
            } catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException
                    | NoSuchMethodException | SecurityException e) {
                e.printStackTrace();
        ...
        public String encodeToString(byte[] src) {
            try {
                return (String) clazz.getMethod("encodeToString", byte[].class).invoke(instance,
                        src);
            } catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException
                    | NoSuchMethodException | SecurityException e) {
                e.printStackTrace();
        ...
        public ByteBuffer encode(ByteBuffer buffer) {
            try {
                return (ByteBuffer) clazz.getMethod("encode", ByteBuffer.class).invoke(instance,
                        buffer);
            } catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException
                    | NoSuchMethodException | SecurityException e) {
                e.printStackTrace();
        ...
        public OutputStream wrap(OutputStream os) {
            try {
                return (OutputStream) clazz.getMethod("wrap", OutputStream.class).invoke(instance,
                        os);
            } catch (IllegalAccessException | IllegalArgumentException | InvocationTargetException
                    | NoSuchMethodException | SecurityException e) {
                e.printStackTrace();
