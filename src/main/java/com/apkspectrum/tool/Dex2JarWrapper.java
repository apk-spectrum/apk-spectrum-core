...
public class Dex2JarWrapper {
    ...
    static public void convert(String dexFilePath, DexWrapperListener listener) {
    ...
    static public void convert(final String dexFilePath, final String toJarFilePath,
            final DexWrapperListener listener) {
        new Thread(new Runnable() {
            public void run() {
                ...
                if (SystemUtil.isWindows()) {
                    cmdLog = ConsolCmd.exec(new String[] {_RFile.BIN_DEX2JAR.getPath(), dexFilePath,
                            "-o", toJarFilePath});
