...
public abstract class AbstractPlugIn implements PlugIn {
    ...
    public String getActionCommand() {
        ...
        return getPackageName() + "!" + typeName + "@" + getName() + "[0x"
                + Integer.toHexString(component.hashCode()) + "]";
    }

    @Override
    public Action makeAction() {
        return makeAction(this instanceof ActionListener ? (ActionListener) this : null);
    }
        ...
        if (listener instanceof Action) {
            ...
            action = new AbstractUIAction() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (posision != null && e.getSource() instanceof JComponent) {
    ...
    public Map<String, Object> getChangedProperties() {
        ...
        if (component.enabled != isEnabled(false)) {
            if (!(this instanceof ExternalTool) || ((ExternalTool) this).isSupoortedOS()) {
