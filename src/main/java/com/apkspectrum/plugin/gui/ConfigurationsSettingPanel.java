...
public class ConfigurationsSettingPanel extends JPanel implements ActionListener {
    ...
    public ConfigurationsSettingPanel(PlugInPackage pluginPackage) {
        ...
        confListModel = new DefaultTableModel(
                new String[] {_RStr.LABEL_KEY_NAME.get(), _RStr.LABEL_KEY_VALUE.get()}, 0) {
        ...
        // )
        GridBagConstraints gridHeadConst = new GridBagConstraints(0, 0, 1, 1, 0, 0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(5, 5, 5, 5), 0, 0);
        GridBagConstraints gridDataConst =
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        switch (e.getActionCommand()) {
            ...
            case ACT_CMD_ADD:
                ...
                do {
                    repeat = false;
                    int ret = MessageBoxPane.showConfirmDialog(parent, confSetPane,
                            _RStr.TITLE_EDIT_CONFIG.get(), JOptionPane.OK_CANCEL_OPTION,
