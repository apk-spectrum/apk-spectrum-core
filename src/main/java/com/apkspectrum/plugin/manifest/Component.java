...
public class Component {
    ...
    Component(int type, boolean enable, String label, String icon, String description, String name,
            String url, /* Linker[] linkers */
            String target, String preferLang, String path, String param, String updateUrl,
            String pluginGroup, String like, String supportedOS, Boolean visibleToBasic,
            String periodDay, String targetPackageName) {
        this.type = type;
        this.enabled = enable;
        this.label = label;
        this.icon = icon;
    ...
    public boolean equals(Object obj) {
        ...
        if (targetPackageName == null) {
            if (other.targetPackageName != null)
                return false;
        } else if (!targetPackageName.equals(other.targetPackageName))
            return false;
        return true;
    }
}
